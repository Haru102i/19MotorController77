...
*/
#define BSP_CFG_MCU_PART_FUNCTION   (0xA) // <-- Updated by GUI. Do not edit this value manually
...
/* Peripheral Module Clock C Divider (PCKC).
   Available divisors = /1 (no division), /2, /4, /8, /16, /32, /64
*/
#define BSP_CFG_PCKC_DIV                (1) // <-- Updated by GUI. Do not edit this value manually
...
*/
#define BSP_CFG_MCU_VCC_MV                          (5000) // <-- Updated by GUI. Do not edit this value manually
...
/* This macro is used to define the analog voltage that is supplied to the MCU (AVcc). This macro is defined in 
   ...
   NOTE: Set values appropriate for the user system.
 */
#define BSP_CFG_MCU_AVCC_MV                         (5000) // <-- Updated by GUI. Do not edit this value manually
...
*/
#define BSP_CFG_AD_NEGATIVE_VOLTAGE_INPUT_AN000     (0) // <-- Updated by GUI. Do not edit this value manually
#define BSP_CFG_AD_NEGATIVE_VOLTAGE_INPUT_AN001     (0) // <-- Updated by GUI. Do not edit this value manually
#define BSP_CFG_AD_NEGATIVE_VOLTAGE_INPUT_AN002     (0) // <-- Updated by GUI. Do not edit this value manually
#define BSP_CFG_AD_NEGATIVE_VOLTAGE_INPUT_PGAVSS0   (0) // <-- Updated by GUI. Do not edit this value manually
#define BSP_CFG_AD_NEGATIVE_VOLTAGE_INPUT_AN100     (0) // <-- Updated by GUI. Do not edit this value manually
#define BSP_CFG_AD_NEGATIVE_VOLTAGE_INPUT_AN101     (0) // <-- Updated by GUI. Do not edit this value manually
#define BSP_CFG_AD_NEGATIVE_VOLTAGE_INPUT_AN102     (0) // <-- Updated by GUI. Do not edit this value manually
#define BSP_CFG_AD_NEGATIVE_VOLTAGE_INPUT_PGAVSS1   (0) // <-- Updated by GUI. Do not edit this value manually
